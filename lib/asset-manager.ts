...
export class AssetManager {
      ...
      characters: {
        xiaoyu: {
          themes: [
            {
              name: 'pink',
              path: '/role-photos/girl/xiaoyu-lolita-pink-001.png',
            },
            {
              name: 'blue',
              path: '/role-photos/girl/xiaoyu-lolita-blue-008.png',
            },
            {
              name: 'purple',
              path: '/role-photos/girl/xiaoyu-lolita-pink-006.png',
            },
          ],
          expressions: [
            {
              name: 'happy',
              path: '/role-photos/girl/xiaoyu-lolita-pink-003.png',
            },
            {
              name: 'excited',
              path: '/role-photos/girl/xiaoyu-lolita-pink-005.png',
            },
            {
              name: 'thinking',
              path: '/role-photos/girl/xiaoyu-lolita-blue-009.png',
            },
            {
              name: 'cool',
              path: '/role-photos/girl/xiaoyu-lolita-blue-011.png',
            },
            {
              name: 'loving',
              path: '/role-photos/girl/xiaoyu-lolita-pink-002.png',
            },
          ],
          defaultTheme: 'blue',
        ...
        xiaoyan: {
          ...
          expressions: [
            ...
            {
              name: 'thinking',
              path: '/role-photos/boy/xiaoyan-formal-003.png',
            },
  ...
  getExpressionAssetPath(
    ...
    const expression = characterManifest.expressions.find(
  ...
  // 获取传统资源路径（向后兼容）
  private getLegacyAssetPath(
    character: CharacterConfig,
    assetName: string,
    assetType: 'theme' | 'expression'
  ): string {
    if (assetType === 'theme') {
  ...
  async validateCharacterAssets(character: CharacterConfig): Promise<{
    ...
    const assetPaths = [
      ...
      ...character.expressions.map(e =>
        this.getExpressionAssetPath(character, e.name)
      ),
    ];
    ...
    const invalid = uniquePaths.filter(
      (_, index) =>
...
// 导出便捷函数
export const getThemeAssetPath = (
  character: CharacterConfig,
  themeName: string
) => assetManager.getThemeAssetPath(character, themeName);

export const getExpressionAssetPath = (
  character: CharacterConfig,
  expressionName: string
