...
export class YanyuMemoryGuardian {
    ...
    const stages: GrowthStage[] = [
      {
        ...
        ageMessage:
          '愿你在数据洪流中，永远保有触摸世界的纯粹感知力，AI会记录成长轨迹，但你的笑声是无可替代的原始数据。',
      },
      {
        age: 3,
        stageName: '三岁探索',
        ...
        ageMessage:
          '在这个语言爆发期，让河洛文化的韵律滋养你的表达，在探索中建立对世界的认知。',
      },
      {
        age: 6,
        stageName: '六岁衔接',
        ...
        ageMessage:
          '即将踏入数字化学习旅程，愿你既能熟练运用智能工具，又能在跳绳的节奏里，感受脱离屏幕的真实生命力。',
      },
      {
        age: 12,
        stageName: '十二岁入初',
        ...
        ageMessage:
          '在知识的海洋中航行，让河洛文化的智慧成为你的罗盘，在数字化时代保持人文温度。',
      },
      {
        age: 15,
        stageName: '十五岁入高',
        ...
        ageMessage:
          '在人工智能时代，既要掌握前沿科技，更要守护人文精神，让河洛文化在你的创新中焕发新生。',
      },
      {
        age: 18,
        stageName: '十八岁成人',
        ...
        ageMessage:
          '成年之际，愿你以河洛文化的底蕴面对世界，用AI的能力创造价值，以人文的智慧引领未来。',
      },
    ];
   ...
   * 为特定守护者角色生成建议
   */
  private generateGuardianRecommendations(
    role: GuardianRole,
    age: number
  ): string[] {
    const stage = this.getGrowthStage(age);
    ...
    return [...baseRecommendations, ...(ageSpecificRecommendations[age] || [])];
  }
   ...
   * 获取文化主题建议
   */
  getCulturalThemeRecommendations(
    age: number,
    season?: string
  ): {
    theme: string;
    ...
    const currentTheme = season
      ? seasonThemes[season as keyof typeof seasonThemes]
      : seasonThemes.spring;
