            ...
            <div className='mb-6 bg-white/70 rounded-2xl p-4 flex items-center gap-4'>
              ...
              <div className='flex-1'>
                <h3 className='font-bold text-slate-800'>
                  {currentChild.name}的作业
                </h3>
                <p className='text-sm text-slate-500'>
                  {growthStageData.exactAge?.years || 0}岁
            ...
            >
              ...
              <div className='p-4'>
                <SmartHomeworkHelper
                  ...
                  subject={
                    homeworkData.find(hw => hw.id === activeHomeworkId)
                      ?.subject || ''
                  }
                  title={
                    homeworkData.find(hw => hw.id === activeHomeworkId)
                  ...
                  onHomeworkComplete={results =>
                    handleHomeworkComplete(activeHomeworkId, results)
                  }
                />
              </div>
            </motion.div>
