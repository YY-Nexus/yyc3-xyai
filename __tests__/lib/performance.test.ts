...
describe('Performance 性能监控测试', () => {
  ...
  it('应该能够记录性能历史', () => {
    const performanceHistory = [
      { timestamp: Date.now() - 60000, fps: 55, memoryUsage: 800 * 1024 * 1024 },
      { timestamp: Date.now() - 30000, fps: 58, memoryUsage: 900 * 1024 * 1024 },
  ...
  it('应该能够分析性能趋势', () => {
    ...
    const trend = performanceData[2].fps > performanceData[0].fps ? 'improving' : 'declining'
