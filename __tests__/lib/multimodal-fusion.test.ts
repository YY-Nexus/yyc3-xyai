...
describe('Multimodal Fusion 多模态融合测试', () => {
  ...
  // 测试模态类型
  it('应该支持不同的模态类型', () => {
    const modalityTypes = ['text', 'image', 'audio', 'video', 'sensor'] as const
  ...
  it('应该能够融合模态', () => {
    const modalities = [
      ...
      { id: '2', type: 'image', data: 'image-data', confidence: 0.90 },
  ...
  it('应该能够过滤模态', () => {
    const modalities = [
      ...
      { id: '2', type: 'image', confidence: 0.60 },
      { id: '3', type: 'audio', confidence: 0.85 },
    ]

    // 按置信度过滤
    const highConfidenceModalities = modalities.filter(m => m.confidence >= 0.8)
  ...
  it('应该能够排序模态', () => {
    const modalities = [
      { id: '3', type: 'audio', confidence: 0.85 },
      { id: '1', type: 'text', confidence: 0.95 },
      { id: '2', type: 'image', confidence: 0.90 },
    ]
    ...
    expect(modalities[1].confidence).toBe(0.90)
  ...
  it('应该能够解决模态冲突', () => {
    const modalities = [
      { id: '1', type: 'text', data: 'Hello', confidence: 0.95 },
      { id: '2', type: 'image', data: 'Goodbye', confidence: 0.90 },
    ]
