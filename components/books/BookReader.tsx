...
export default function BookReader({
  ...
  return (
    ...
    >
        ...
        {showControls && (
          ...
          >
            <div className='flex items-center justify-center gap-6 px-6 py-4'>
              ...
              >
                <i
                  className={`${isPlaying ? 'ri-pause-line' : 'ri-play-line'} text-3xl`}
                />
              </button>
              ...
              <button
                onClick={() =>
                  onPageChange(Math.min(book.pages.length, currentPage + 1))
                }
                className='p-3 rounded-full text-slate-600 hover:bg-amber-100 hover:text-amber-600 transition-all'
              >
      ...
      <button
        onClick={() =>
          currentPage < book.pages.length && onPageChange(currentPage + 1)
        }
