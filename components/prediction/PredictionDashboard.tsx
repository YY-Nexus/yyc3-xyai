...
const PredictionDashboard: React.FC<PredictionDashboardProps> = ({
  ...
  const [chartType, setChartType] = useState<'line' | 'area' | 'scatter'>(
    'line'
  );
  ...
  const chartData = useMemo(() => {
    const data = filteredPredictions.map(p => ({
      ...
      lower:
        (p.metadata?.['confidenceInterval'] as { lower: number })?.lower ??
        null,
      upper:
        (p.metadata?.['confidenceInterval'] as { upper: number })?.upper ??
        null,
      ...
      <div className='flex items-center justify-between'>
        ...
        <div className='flex items-center space-x-4'>
          <div className='flex items-center space-x-2'>
            ...
            <Switch id='realtime-toggle' checked={isRealTime} disabled />
          </div>
          {onModelUpdate && (
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className='text-xs text-muted-foreground'>预测可靠性指标</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className='text-2xl font-bold text-orange-600'>
              {biasReport
                ? biasReport.overall === 'low'
                  ? '低'
                  : biasReport.overall === 'medium'
                    ? '中'
                    : '高'
                : '---'}
            </div>
            <p className='text-xs text-muted-foreground'>公平性评估结果</p>
          </CardContent>
        </Card>
          ...
          <CardContent>
            <div className='text-2xl font-bold text-red-600'>
              {insights?.riskAssessment?.overall
                ? insights.riskAssessment.overall === 'low'
                  ? '低'
                  : insights.riskAssessment.overall === 'medium'
                    ? '中'
                    : '高'
                : '---'}
            </div>
            <p className='text-xs text-muted-foreground'>概念漂移风险评估</p>
          </CardContent>
        </Card>
      </div>
        ...
        <CardHeader>
          <div className='flex items-center justify-between'>
            ...
            <div className='flex items-center space-x-4'>
              <Select
                value={chartType}
                onValueChange={(value: 'line' | 'area' | 'scatter') =>
                  setChartType(value)
                }
              >
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>模型在各维度上的表现评估</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>基于预测结果的重要发现和建议</CardDescription>
          </CardHeader>
          <CardContent>
            {insights?.keyPoints ? (
      ...
      {onPredictionRequest && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>配置预测参数并生成新的预测</CardDescription>
          </CardHeader>
