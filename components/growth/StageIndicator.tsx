          ...
          >
            <div className='flex items-center gap-2'>
              ...
              <span className='text-sm'>
                ...
                <strong>
                  {' '}
                  {AGE_STAGES[approachingNextStage.nextStage]?.name}
                </strong>
              </span>
            </div>
          </motion.div>
              ...
              <div className='mb-6'>
                ...
                <div className='space-y-2'>
                  {recommendations.books.map((book, i) => (
                    <div
                      key={i}
                      className='bg-blue-50 text-blue-700 px-3 py-2 rounded-xl text-sm'
                    >
                      {book}
                    </div>
                  ))}
              ...
              <div>
                ...
                <div className='space-y-2'>
                  {recommendations.warnings.map((warning, i) => (
                    <div
                      key={i}
                      className='bg-red-50 text-red-700 px-3 py-2 rounded-xl text-sm flex items-start gap-2'
                    >
