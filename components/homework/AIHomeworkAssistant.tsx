...
export default function AIHomeworkAssistant({
  homework,
  isOpen,
  onClose,
  onComplete,
}: AIHomeworkAssistantProps) {
  const [activeTab, setActiveTab] = useState<'guide' | 'solve' | 'analyze'>(
    'guide'
  );
                  ...
                  <div className='bg-red-50 rounded-2xl p-4'>
                    ...
                    <div className='space-y-2 text-sm text-slate-600'>
                      {homework.subject === '数学' && (
                        <>
                          <p>
                            • <strong>计算错误</strong>：加减法时注意进位和退位
                          </p>
                          <p>
                            • <strong>步骤遗漏</strong>：记得写出完整的计算过程
                          </p>
                          <p>
                            • <strong>单位遗漏</strong>：应用题要注意单位转换
                          </p>
                        </>
                      )}
                      {homework.subject === '语文' && (
                        <>
                          <p>
                            • <strong>错别字</strong>：要注意形近字的区别
                          </p>
                          <p>
                            • <strong>标点符号</strong>：正确使用标点符号
                          </p>
                          <p>
                            • <strong>句子结构</strong>：检查句子是否完整通顺
                          </p>
                        </>
                      )}
                      {homework.subject === '英语' && (
                        <>
                          <p>
                            • <strong>拼写错误</strong>：注意单词的正确拼写
                          </p>
                          <p>
                            • <strong>时态错误</strong>：正确使用动词时态
                          </p>
                          <p>
                            • <strong>单复数</strong>：注意名词的单复数形式
                          </p>
                        </>
                      )}
                    </div>
