...
const xiaoyuPhotos: Photo[] = [
  {
    ...
    isFavorite: true,
    story:
      '这是小语来到世界的第一天，全家人都激动得热泪盈眶。这个小生命给我们带来了无尽的欢乐和希望。',
  },
  {
    id: '2',
    ...
    isFavorite: true,
    story:
      '今天小语第一次对妈妈露出了天使般的笑容，那一刻妈妈的心都融化了。这是最珍贵的回忆之一。',
  },
  {
    id: '3',
    ...
    isFavorite: true,
    story:
      '小语100天啦！全家人为她举办了隆重的庆祝派对，好多亲戚朋友都来为小宝贝送上祝福。',
  },
  {
    id: '4',
    ...
    isFavorite: true,
    story:
      '小语第一次成功爬行！虽然只是一小段距离，但这是她探索世界的重要一步。爸爸妈妈在旁边为她鼓掌加油！',
  },
  {
    id: '5',
    ...
    isFavorite: true,
    story:
      '小语1岁生日啦！全家人围在一起为她唱生日歌，小宝贝虽然还不太明白，但看到蛋糕时眼睛亮晶晶的。',
  },
];
